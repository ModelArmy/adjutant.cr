...
# NOTE: A lot is missing, doesn't mean we want to do all of this
#    Just tracking.
##
# Literals ISO Test
...
assert('Literals Numerical', '8.7.6.2') do
  ...
  assert_equal(-1.0, -1.0)
  # binary
  # assert_equal 128, 0b10000000 # TODO: 0bNNN binary literals
  # assert_equal 128, 0B10000000
  # octal
  # assert_equal 8, 0o10 # TODO: 0oNNN octal literals
  # assert_equal 8, 0O10
  # assert_equal 8, 0_10
  # hex
...
# --- TODO: % not parsed for quoted literals
...
# --- TODO: HEREDOC literals not supported
# --- TODO: Array and Hash literals
...
assert('Literals Symbol', '8.7.6.6') do
  ...
  # --- TODO? SHOULD WE? Symbols with non-letter-number characters?
  # :$asd
  # :@asd
  # :@@asd
  # :asd=
  ...
  a = :"asd qwe"
  b = :'foo bar'
  c = :"a#{1+2}b" # TODO: interpolated strings

  # --- TODO: % prefix literals
  #   d = %s(asd)
  #   e = %s( foo \))
  #   f = %s[asd \[
  # qwe]
...
# --- TODO: Pending `Class` and other syms
