...
# --- WONTFIX: Dynamic class definition now supported
...
# --- TODO: pending String class
# assert('Class#superclass', '15.2.3.3.4') do
#   class SubClass < String; end
#   assert_equal(String, SubClass.superclass)
# end
# --- INSTEAD test using Integer
assert('Class#superclass', '15.2.3.3.4') do
  class SubClass < Integer; end
  assert_equal(Integer, SubClass.superclass)

  class ExSubClass < Exception; end
  assert_equal(Exception, ExSubClass.superclass)
end
# ---
...
# --- TODO: Raise TypeError when redefining class with different superclass
# assert('Class 7') do
#   class C7_A; end
#   class C7_B; end
...
# --- TODO: FIX: Custom module's class should be Module
...
# --- TODO - using :: to define nested classes
# # nested class
...
# --- TODO? Dynamic constant definition for class ??
...
# --- TODO: Using :: to define nested (or root) class
...
# --- WONTFIX: Dynamic class definition via Class.new
# assert('Class.new') do
...
# --- WONTFIX: Class definition as expression
