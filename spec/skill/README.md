...
`1a49f3b`                     |qwen3.8         |4/4 tasks                   |02 in under 50s: `counts.to_a` then `sort_by` on `[-pair[1], pair[0]]`, the idiomatic answer, first try.                                                                                                                        
...
`c90d591`                     |qwen3.8         |9/9 tasks                   |First sitting of 05–09; no failures, so nothing to classify.                                                                                                                                                                    
