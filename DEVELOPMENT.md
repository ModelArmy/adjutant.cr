...
Known gaps and not-yet-implemented features (beyond the risk-model exclusions above) are tracked in [SCOPE.md](./SCOPE.md), which includes "Must Fix", "Will Fix" and "Won't Support" items.
